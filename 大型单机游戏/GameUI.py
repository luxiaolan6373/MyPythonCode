...
class GameUI():
    ...
    def londlist(self):
        ...
        self.tree = ttk.Treeview(fm, column=titles, yscrollcommand=self.scrollbar.set, show='headings', height=15)
    ...
    def show_download(self):
        ...
        Label(fm, text="百度下载:").grid(row=1, column=0, sticky=W)
        t2 = Entry(fm, textvariable=self.var_baidu, width=100)
        t2.grid(row=1, column=1, sticky=W)
        Label(fm, text="种子下载:").grid(row=2, column=0, sticky=W)
